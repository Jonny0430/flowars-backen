...
export class MailService {
	...
	public async verifyOtp(email: string, otpVerification: string) {
		...
		if (!validOtp) throw new BadRequestException('OTP verification code is not correct, please check your email')
